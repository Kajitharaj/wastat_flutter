    ...
    return Consumer2<TrackerService, BridgeService>(
      builder: (ctx, tracker, bridge, _) {
        return Scaffold(
          ...
          appBar: AppBar(backgroundColor: AppTheme.bgSecondary, title: const Text('Settings')),
          body: ListView(
            children: [
              // ── Bridge status card ─────────────────────
        ...
        builder: (ctx, scroll) => SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('How all the pieces connect', style: TextStyle(color: AppTheme.textSecondary)),
              ...
              Container(
                ...
                child: const Text(
                  ...
                  '  └─ TrackerService\n'
                  '  └─ SQLite database',
                  style: TextStyle(color: AppTheme.primaryGreen, fontFamily: 'monospace', fontSize: 12, height: 1.6),
                ),
              ),
              ...
              _HowItWorksSection(
                step: '1',
                title: 'Baileys (Node.js)',
                body:
                    'Opens a WebSocket to wss://web.whatsapp.com using the '
              ...
              _HowItWorksSection(
                ...
                body:
                    'For each tracked contact, the bridge calls '
              ...
              _HowItWorksSection(
                step: '3',
                title: 'Bridge → Flutter',
                body:
                    'Presence events are forwarded over a WebSocket to your '
              ...
              _HowItWorksSection(
                ...
                body:
                    'TrackerService timestamps every event, calculates session '
              ...
              Container(
                ...
                child: const Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Icon(Icons.warning_amber_rounded, color: AppTheme.awayColor, size: 18),
                    SizedBox(width: 10),
                    Expanded(
                      child: Text(
            ...
            onPressed: () async {
              ...
              if (context.mounted) {
                ScaffoldMessenger.of(
                  context,
                ).showSnackBar(const SnackBar(content: Text('All data cleared'), backgroundColor: AppTheme.bgElevated));
              }
            },
...
class _SettingsTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: Text(
        title,
        style: TextStyle(color: titleColor ?? AppTheme.textPrimary, fontSize: 15, fontWeight: FontWeight.w500),
      ),
      subtitle: subtitle != null
          ? Text(subtitle!, style: const TextStyle(color: AppTheme.textSecondary, fontSize: 12))
          : null,
      trailing: trailing ?? (onTap != null ? const Icon(Icons.chevron_right, color: AppTheme.textTertiary) : null),
      onTap: onTap,
    );
  }
}
...
class _HowItWorksSection extends StatelessWidget {
  ...
  const _HowItWorksSection({required this.step, required this.title, required this.body});
